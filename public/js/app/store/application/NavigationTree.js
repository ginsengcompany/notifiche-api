Ext.define('AdvaSoftLogin.store.application.NavigationTree', {
    ...
    root: {
        ...
        children: [
            ...
            {
                text:   'Lista Dispositivi',
                view:   'view.dispositivi.Dispositivi',
                iconCls: 'right-icon x-fa fa-tablet ',
                leaf:   true,
                routeId: 'dispositivi'
            ...
            {
                text:   'Configurazioni',
                view:   'view.configurazioni.Configurazioni',
                iconCls: 'right-icon fa fa-cog ',
                leaf:   true,
                routeId: 'configurazioni'
            }         
//            {
//                text:   'Login',
